...
# number of parameters in millions in gen and critic
print(f"Generator: {sum(p.numel() for p in generator.parameters()) / 1e6}M")
print(f"Critic: {sum(p.numel() for p in critic.parameters()) / 1e6}M")
exit()
